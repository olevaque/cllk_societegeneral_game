...
public class LinkDisclaimerOpener : MonoBehaviour, IPointerClickHandler
{
    [DllImport("__Internal")]
    private static extern void OpenDisclaimerLink(string url);
    ...
    public void OnPointerClick(PointerEventData eventData)
    {
        ...
        if (linkIndex != -1)
        {
            ...
            OpenDisclaimerLink(linkInfo.GetLinkText());
        }
    }
}